...
# lr = LogisticRegression(penalty='l1', C=25.0, random_state=1, multi_class='ovr', solver='liblinear', max_iter=10000)
# lr.fit(X_train_std, y_train)
## 使用随机搜索调参
#创建逻辑回归模型
# lr = LogisticRegression(penalty='l2', random_state=1,multi_class='ovr', solver='lbfgs', max_iter=10000)
# lr = LogisticRegression(penalty='l2', random_state=1,multi_class='ovr', solver='liblinear', max_iter=10000)
# lr = LogisticRegression(penalty='l1', random_state=1,multi_class='ovr', solver='liblinear', max_iter=10000)
# lr = LogisticRegression(penalty='l2', random_state=1,multi_class='ovr', solver='newton-cg', max_iter=10000)
lr = LogisticRegression(penalty='l2', random_state=1,multi_class='ovr', solver='saga', max_iter=10000)
...
ID = "liblinear_random_"+random_search.best_estimator_.solver
result_df = pd.DataFrame({'ID': [ID],'Accuracy': [accuracy], 'Precision': [precision], 'Recall': [recall],
                          'C':[random_search.best_params_['C']], 'save_path': [save_path]})
